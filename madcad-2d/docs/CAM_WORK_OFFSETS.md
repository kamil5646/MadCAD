...
- Dostępne są prostopadłościenne strefy uchwytów XYZ z zadanym odstępem. Ich przecięcie przez ścieżkę blokuje eksport. Nie zastępują pełnej symulacji uchwytu, oprawki i kinematyki maszyny; brak też operacji sondowania i raportu kolejnych zamocowań. To dalsze części [P5.5](../ROADMAP.md).
