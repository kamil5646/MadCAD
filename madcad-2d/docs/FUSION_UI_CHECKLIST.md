...
- [x] Polecenia powierzchniowe mają aliasy `PA/PATCH`, `SE/SURFACEEXTRUDE`, `SR/SURFACEREVOLVE`, `SS/SURFACESWEEP`, `SLO/SURFACELOFT`, `SO/SURFACEOFFSET` i `TH/THICKEN/POGRUB`, tooltipy oraz wspólny panel parametrów.
