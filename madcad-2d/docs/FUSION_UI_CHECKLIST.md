...
- [x] Polecenia powierzchniowe mają aliasy `PA/PATCH`, `SE/SURFACEEXTRUDE`, `SR/SURFACEREVOLVE`, `SS/SURFACESWEEP` i `TH/THICKEN/POGRUB`, tooltipy oraz wspólny panel parametrów.
