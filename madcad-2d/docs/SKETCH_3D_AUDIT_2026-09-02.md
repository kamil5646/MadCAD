...
Kolejny etap to bezpośrednie przeciąganie punktów i uchwytów spline w widoku oraz zachowanie dokładnej geometrii skojarzonych krawędzi krzywoliniowych i ścieżek leżących na powierzchniach modelu.
