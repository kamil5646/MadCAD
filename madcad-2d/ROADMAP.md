...
- [>] P4.8 Globalne „Idź do”: szybkie wyszukiwanie parametrów, szkiców, operacji, brył, komponentów, arkuszy i linków po nazwie lub typie, uruchamiane z klawiatury i prowadzące bezpośrednio do obiektu bez zmiany projektu.
...
1. [>] Dodać globalne wyszukiwanie projektu „Idź do” z nawigacją klawiaturą jako etap P4.8.
