...
- [>] P4.7 Gdzie używane i wpływ zmiany: czytelny graf zależności parametrów, szkiców, operacji, komponentów i linków, z wyborem obiektu, listą elementów nadrzędnych/podrzędnych oraz przejściem do wskazanej zależności bez zmiany dokumentu.
...
1. [>] Pokazać „Gdzie używane” i wpływ zmiany na grafie zależności projektu jako etap P4.7.
