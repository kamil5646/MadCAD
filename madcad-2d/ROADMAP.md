...
- [x] Kanały alpha/beta/stable, SHA-256, testy paczek, rollback instalacji macOS i updater ignorujący niezaufany adres z renderera są zaimplementowane. Wydanie 6.1.3 jest świadomie publikowane bez certyfikatu, z ostrzeżeniem i ręczną instalacją.
...
- [!] Niepodpisane wydanie 6.1.3 wywołuje ostrzeżenia SmartScreen/Gatekeeper i nie może być instalowane przez bezpieczny wbudowany aktualizator.
