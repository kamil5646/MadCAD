...
- [>] P4.6 Kondycja projektu: jeden raport integralności dokumentu, historii, referencji B-Rep, linków zewnętrznych i rozmiaru danych, z priorytetami, przejściem do problemu oraz eksportem JSON bez automatycznego modyfikowania modelu.
...
1. [>] Dodać raport kondycji i integralności projektu z nawigacją do problemów jako etap P4.6.
