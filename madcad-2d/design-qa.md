...
- WinRAR-style license mode: startup remains unlocked, a non-blocking license reminder is shown, and the token system remains available as an optional activation/support path.
