...
Aktualna stabilna wersja: **6.5.13**.
...
> Instalatory `v6.5.13` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.13` odpowiada wersji `6.5.13` w `package.json`;
