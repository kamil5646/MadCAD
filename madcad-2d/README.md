...
Aktualna stabilna wersja: **6.5.22**.
...
> Instalatory `v6.5.22` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.22` odpowiada wersji `6.5.22` w `package.json`;
