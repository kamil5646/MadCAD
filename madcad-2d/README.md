...
Aktualna stabilna wersja: **6.5.14**.
...
> Instalatory `v6.5.14` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.14` odpowiada wersji `6.5.14` w `package.json`;
