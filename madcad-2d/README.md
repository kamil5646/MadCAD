...
Aktualna stabilna wersja: **6.5.21**.
...
> Instalatory `v6.5.21` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.21` odpowiada wersji `6.5.21` w `package.json`;
