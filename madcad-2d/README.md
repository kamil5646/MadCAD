...
Aktualna stabilna wersja: **6.5.16**.
...
> Instalatory `v6.5.16` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.16` odpowiada wersji `6.5.16` w `package.json`;
