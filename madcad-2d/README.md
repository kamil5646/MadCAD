...
Aktualna stabilna wersja: **6.5.15**.
...
> Instalatory `v6.5.15` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.15` odpowiada wersji `6.5.15` w `package.json`;
