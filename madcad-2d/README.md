...
Aktualna stabilna wersja: **6.5.11**.
...
> Instalatory `v6.5.11` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.11` odpowiada wersji `6.5.11` w `package.json`;
