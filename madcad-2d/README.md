...
Aktualna stabilna wersja: **6.5.12**.
...
> Instalatory `v6.5.12` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.12` odpowiada wersji `6.5.12` w `package.json`;
