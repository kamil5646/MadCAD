...
Aktualna stabilna wersja: **6.5.18**.
...
> Instalatory `v6.5.18` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.18` odpowiada wersji `6.5.18` w `package.json`;
