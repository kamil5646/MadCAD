...
Aktualna stabilna wersja: **6.5.17**.
...
> Instalatory `v6.5.17` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.17` odpowiada wersji `6.5.17` w `package.json`;
