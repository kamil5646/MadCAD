...
Aktualna stabilna wersja: **6.5.10**.
...
> Instalatory `v6.5.10` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.10` odpowiada wersji `6.5.10` w `package.json`;
