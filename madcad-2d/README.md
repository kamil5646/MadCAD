...
Aktualna stabilna wersja: **6.5.19**.
...
> Instalatory `v6.5.19` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.19` odpowiada wersji `6.5.19` w `package.json`;
