...
- Osobne menu `Blacha` tworzy bazę z jednego zamkniętego profilu, a następnie parametryczne kołnierze na prostych krawędziach tej samej bryły B-Rep. Reguła zachowuje grubość, promień gięcia i współczynnik K; bryła jest oznaczona jako `BLACHA`, a baza i kołnierze współpracują z podglądem, historią oraz Cofnij/Ponów bez utraty szkicu źródłowego.
