...
Aktualna stabilna wersja: **6.5.20**.
...
> Instalatory `v6.5.20` nie mają podpisu producenta. Windows SmartScreen lub
...
- tag `v6.5.20` odpowiada wersji `6.5.20` w `package.json`;
