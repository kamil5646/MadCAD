...
if (packageJson.version !== '6.5.17') throw new Error(`Wersja stabilna musi wynosić 6.5.17, jest ${packageJson.version}.`);
...
expectText(site, /paczki 6\.5\.17 są publikowane bez podpisu producenta/, 'ostrzeżenie o niepodpisanym wydaniu 6.5.17');
...
expectText(rootReadme, /Uwaga o wydaniu 6\.5\.17/, 'ostrzeżenie wydania w README');
...
expectText(appDialogs, /Wydanie 6\.5\.17 nie ma podpisu producenta/, 'ostrzeżenie o podpisie w aplikacji');
