...
if (packageJson.version !== '6.5.12') throw new Error(`Wersja stabilna musi wynosić 6.5.12, jest ${packageJson.version}.`);
...
expectText(site, /paczki 6\.5\.12 są publikowane bez podpisu producenta/, 'ostrzeżenie o niepodpisanym wydaniu 6.5.12');
...
expectText(rootReadme, /Uwaga o wydaniu 6\.5\.12/, 'ostrzeżenie wydania w README');
...
expectText(appDialogs, /Wydanie 6\.5\.12 nie ma podpisu producenta/, 'ostrzeżenie o podpisie w aplikacji');
