...
app.whenReady().then(async () => {
  ...
  try {
    ...
    const expectedTabs = ['BRYŁA', 'POWIERZCHNIA', 'SIATKA', 'KONSTRUKCJA BLACHOWA', 'TWORZYWO SZTUCZNE', 'NARZĘDZIA'];
