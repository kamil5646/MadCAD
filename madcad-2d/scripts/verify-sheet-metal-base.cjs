...
app.whenReady().then(async () => {
  ...
  try {
    ...
    await clickTool(window, 'Kołnierz blachy');
    ...
    await clickTool(window, 'Zawinięcie blachy');
    ...
    await clickTool(window, 'Szczelina blachy');
    ...
    await clickTool(window, 'Rozwiń blachę');
    ...
    await clickTool(window, 'Zagnij ponownie');
