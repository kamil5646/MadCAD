...
function featureExpressions(feature) {
  ...
  if (feature.type === 'formBody') return [feature.width, feature.depth, feature.height, feature.subdivisions, feature.x, feature.y, feature.z, feature.insertEdgePosition, feature.bridgeInset, ...(feature.controlOffsets || []).flat(), ...(feature.insertEdgeOffsets || []).flat(), ...(feature.bridgeOffsets || []).flat()];
