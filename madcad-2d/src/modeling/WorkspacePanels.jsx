...
export function ComponentPanel({ document, bodies = [], selectedComponentId = '', selectedInstanceId = '', selectedJointId = '', selectedBodyIds = [], readOnly = false, onCreate, onUpdate, onAssignBodies, onMove, onDelete, onSelect, onSelectInstance, onCreateInstance, onUpdateInstance, onDuplicateInstance, onDeleteInstance, onCreateRigidGroup, onDeleteRigidGroup, onSelectJoint, onCreateJoint, onUpdateJoint, onSetJointValue, onDeleteJoint, onClose }) {
