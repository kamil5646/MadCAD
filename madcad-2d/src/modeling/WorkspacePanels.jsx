    ...
    <aside className="measure-panel component-panel" aria-label="Komponenty i złożenia">
      ...
      <section className="component-storyboard" aria-label="Storyboard animacji złożenia">
        ...
        {activeStoryboard && <>
          ...
          <div className="storyboard-export"><button type="button" disabled={storyboardExporting || activeStoryboard.keyframes.length < 2} onClick={() => onExportStoryboardVideo?.(activeStoryboard)}><Film size={13} /> {storyboardExporting ? 'Nagrywanie…' : 'Film WebM'}</button><button type="button" disabled={storyboardExporting} onClick={() => onExportStoryboardInstructions?.(activeStoryboard)}><FileDown size={13} /> Instrukcja HTML</button></div>
