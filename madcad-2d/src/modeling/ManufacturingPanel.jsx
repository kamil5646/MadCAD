          ...
          {setup.operations.map((operation, operationIndex) => {
            ...
            return <section className="manufacturing-operation" key={operation.id}>
              ...
              <div className="manufacturing-form operation-form">
                ...
                {(isContour || isPocket) && <div className="manufacturing-boundary"><Crosshair size={13} /><span><strong>Granica</strong><small>{operation.boundaryFaceId ? 'Zaznaczona pozioma ściana' : 'Automatycznie: górny obrys bryły'}</small></span></div>}
