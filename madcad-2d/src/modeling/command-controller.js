const COMMAND_DEFINITIONS = Object.freeze([
  ...
  { category: 'POWIERZCHNIE', shortcut: 'SO', label: 'Surface Offset', toolLabel: 'Surface Offset', aliases: ['SO', 'SURFACEOFFSET', 'ODSUNPOWIERZCHNIE', 'ODSUŃPOWIERZCHNIĘ'] },
  { category: 'POWIERZCHNIE', shortcut: 'STI', label: 'Stitch', toolLabel: 'Stitch', aliases: ['STI', 'STITCH', 'ZSZYJ', 'ZSZYJPOWIERZCHNIE'] },
  { category: 'POWIERZCHNIE', shortcut: 'STR', label: 'Surface Trim', toolLabel: 'Surface Trim', aliases: ['STR', 'SURFACETRIM', 'PRZYTNIJPOWIERZCHNIE', 'PRZYTNIJPOWIERZCHNIĘ'] },
  { category: 'POWIERZCHNIE', shortcut: 'SXT', label: 'Surface Extend', toolLabel: 'Surface Extend', aliases: ['SXT', 'SURFACEEXTEND', 'PRZEDLUZPOWIERZCHNIE', 'PRZEDŁUŻPOWIERZCHNIĘ'] },
...
const ACTIVE_COMMAND_LABELS = Object.freeze({
  ...
  surfaceSweep: 'SURFACE SWEEP',
  surfaceLoft: 'SURFACE LOFT',
  surfaceOffset: 'SURFACE OFFSET',
  surfaceStitch: 'STITCH',
  surfaceTrim: 'SURFACE TRIM',
  surfaceExtend: 'SURFACE EXTEND',
