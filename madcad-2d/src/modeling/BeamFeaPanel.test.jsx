...
describe('BeamFeaPanel', () => {
  it('shows validated results and updates mesh density', () => {
    ...
    render(<BeamFeaPanel bodies={[{ id: 'body-1', name: 'Belka' }]} bodyId="body-1" result={{ status: 'safe', elementCount: 8, nodeCount: 9, tipDeflection: 0.5, convergenceError: 0, maximumStress: 100, reactionForce: 500, reactionMoment: 50000, safetyFactor: 2.35, limitations: ['Model belkowy.'] }} onChange={onChange} onClose={vi.fn()} />);
