...
describe('BeamFeaPanel', () => {
  it('shows validated results and updates mesh density', () => {
    ...
    expect(screen.getByLabelText(/Scenariusze obciążenia MES/i)).toHaveTextContent('Krytyczny: Przeciążenie ×1,5');
    expect(screen.getByLabelText(/Scenariusze obciążenia MES/i)).toHaveTextContent('FoS 0,52');
