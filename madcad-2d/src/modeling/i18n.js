const ENGLISH_TEXT = Object.freeze({
  ...
  'MadCAD działa bez klucza, tokenu i aktywacji.': 'MadCAD works without a key, token, or activation.',
  'Wszystkie funkcje aplikacji są dostępne od razu po uruchomieniu. Nie trzeba podawać identyfikatora urządzenia ani żadnego klucza.': 'All application features are available immediately. No device identifier or key is required.',
  'Zasady korzystania': 'Terms of use',
  'Możesz używać MadCAD prywatnie i komercyjnie zgodnie z licencją projektu.': 'You may use MadCAD privately and commercially under the project license.',
  'Redystrybucja i modyfikowanie aplikacji podlegają warunkom pełnej licencji.': 'Redistribution and modification are subject to the full license terms.',
  'Aplikacja nie blokuje narzędzi i nie wyświetla przypomnień aktywacyjnych.': 'The application does not lock tools or display activation reminders.',
