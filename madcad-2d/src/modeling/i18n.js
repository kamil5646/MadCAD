const ENGLISH_TEXT = Object.freeze({
  ...
  'Licencja prywatna i wsparcie': 'Private-use license and support',
  'Przed rozpoczęciem pracy sprawdź zasady korzystania z MadCAD.': 'Before you begin, review the MadCAD terms of use.',
  'MadCAD jest bezpłatny wyłącznie do użytku prywatnego i niezarobkowego.': 'MadCAD is free only for private, non-commercial use.',
  'Użytek komercyjny jest płatny': 'Commercial use requires payment',
  'Praca zarobkowa, firmowa, usługowa, produkcyjna lub dla klienta wymaga odrębnej pisemnej licencji komercyjnej i opłaty.': 'Paid, business, service, production, or client work requires a separate written commercial license and payment.',
  ...
  'Aplikacja nie wymaga klucza ani tokenu — obowiązują jednak warunki pełnej licencji.': 'The application does not require a key or token, but the full license terms still apply.',
