  ...
  return (
    <section className="command-dialog" aria-label={title}>
      ...
      <div className="command-dialog-body">
        ...
        {(isExtrude || isRevolve || isSweep || isLoft || (isHole && command.placement !== 'face-edges')) && <Field label={isLoft ? 'Profil początkowy' : 'Profil'} value={profileName} disabled />}
        {isExtrude && (
          <>
