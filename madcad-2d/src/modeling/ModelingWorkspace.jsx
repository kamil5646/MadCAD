      ...
      if (next.type === 'hole') {
        next.previewFeature = next.placement === 'face-edges'
          ? createFeature('hole', {
            ...
            holeStandard: next.holeStandard, holeApplication: next.holeApplication, standardSize: next.standardSize, clearanceClass: next.clearanceClass, threadClass: next.threadClass, threadDesignation: next.threadDesignation,
