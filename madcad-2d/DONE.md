...
- [x] Schemat dokumentu v6, migracje v2 → v3 → v4 → v5 → v6, walidacja oraz tryb nowszego dokumentu tylko do odczytu.
...
- [x] P2.4 dodaje podstawowe ramki GD&T, edytowalną tabliczkę, historię rewizji i eksport DXF w milimetrach; schemat v8 migruje v7, a desktop E2E sprawdza cały arkusz bez przepełnienia.

- Testy rdzenia: 148 zaliczonych, 0 błędów.
